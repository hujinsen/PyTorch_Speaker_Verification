...
def process_one_folder(folder, i, utter_min_len, train_speaker_num):
...
def save_spectrogram_tisv():
    ...
    for i, folder in enumerate(audio_path):
        futures.append(executor.submit(process_one_folder, folder, i, utter_min_len, train_speaker_num))
